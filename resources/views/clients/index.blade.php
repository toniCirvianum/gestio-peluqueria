    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="GET" action="{{ route('clients.index') }}" class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Filtre per nom -->
                    <div>
                ...
                <div class="flex space-x-4 ">
                    ...
                    <a href="/clients/create" class="bg-blue-500 text-white px-4 py-2 h-full rounded hover:bg-blue-600 transition">+</a>
                </div>
